...
import Imagenes from "../album/Imagenes";
          ...
          <tbody>
            <tr>
              ...
              <td id="content" className="app_content">
                ...
                <LoggedInRoute path="/album/:id" component={Album} />
                <LoggedInRoute path="/imagenes/:albumId" component={Imagenes} />
                ...
                <LoggedInRoute path="/newAlbum/:petId" component={NewAlbum} />
