...
- [Album](#album)
	- [Guardar Imagen de Album](#guardar-imagen-de-album)
	- [Buscar Album de mascota](#buscar-album-de-mascota)
	- [Obtiene todos los ids imagenes de un album](#obtiene-todos-los-ids-imagenes-de-un-album)
...
- [album](#album)
	- [Eliminar album](#eliminar-album)
	


# <a name='album'></a> Album

## <a name='guardar-imagen-de-album'></a> Guardar Imagen de Album
[Back to top](#top)

<p>Guarda una imagen de un album  en la db y actualiza el la entidad ImagenAlbum</p>

	POST /v1/album/picture
...
```
## <a name='buscar-album-de-mascota'></a> Buscar Album de mascota
[Back to top](#top)

<p>Obtiene el album de la mascota.</p>
...
```
## <a name='obtiene-todos-los-ids-imagenes-de-un-album'></a> Obtiene todos los ids imagenes de un album
[Back to top](#top)

<p>Obtiene un listado de los ids de las imagenes de un album.</p>
...
## <a name='eliminar-album'></a> Eliminar album
[Back to top](#top)

<p>Eliminar un album.</p>
